...
<div class="modal fade" id="infoModal" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel" aria-hidden="true">
	...
	<div class="modal-content">
		...
		<div class="modal-body">
			...
			<h3>特長</h3>
			<ul>
				<li>各行にマウスを置くと該当のキーが青くハイライト</li>
				<li>キーボードタイプ（テンキーあり／なし／Macbook）を切り替え可能<br>※Shift-JISのみ</li>
				<li>アプリケーション毎にリストを切り替え</li>
				<li>行頭をクリックして昇順または降順に並べ替え</li>
				<li>Favorite（お気に入り）をクリックして記録</li>
			</ul>
			<h3>仕組み</h3>
